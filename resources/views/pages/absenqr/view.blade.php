            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <form method="GET" action="{{ route('qr.view', ['id' => request()->route('id')]) }}"
                            class="form-inline">
                        ...
                        <div>
                            <a href="{{ route('absen.index') }}" class="btn btn-warning mr-2">
                                <i class="fas fa-arrow-left"></i> Kembali
                            </a>
                            <a href="{{ route('qr.createAdd', ['id' => request()->route('id')]) }}" class="btn btn-primary">
